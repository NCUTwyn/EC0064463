...
def main_proc(theNET,eps,alpha):
    ...
    for theta in np.arange(0, 1.1, 0.1):
        ...
        oldc_ratio = [1 - (a / l)]
        for b in np.arange(1, 1.05, 0.005):
            Amat = np.mat(([1, 0], [b, 0]))
            print(b)
...
if __name__ == "__main__":
    (c_ratio) =main_proc(theNET,eps,alpha)
...
print(d)
d.to_csv('D:/111111111研三论文/更改之后的数据/eps/eps-图3-BA-theta2-b-1-05-gamma-0-5.csv')
